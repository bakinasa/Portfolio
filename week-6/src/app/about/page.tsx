    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Learn more about me, my skills, and my experiences."/>
            </Head>
            <section id="bio" className="m-8 mt-20 p-8">
                ...
                <div className="flex flex-col lg:flex-row mb-8">
                    <div className="flex-1 p-5 border-l-2 border-gray-950">
                        ...
                        <p>
                            Creative Frontend Developer. Well versed in React, Tailwind CSS, JavaScript. Focused on
                            creating
                            well adaptable user-friendly interfaces and beautiful animations. Have experience in UI-UX
                            design.
                            Studying backend and machine learning to better understand the complete process of building
                            full-fledged
                            applications.
                        </p>
                ...
                <div id="contact"
                     className="flex flex-wrap justify-between items-center p-6 mt-8 border-t-2 border-b-2 border-black">
                    ...
                    <a href="mailto:your.email@example.com"
                       className="p-4 bg-gray-800 text-white rounded-lg transition hover:bg-gray-600">
                        Write me
                    </a>
                </div>
            </section>
