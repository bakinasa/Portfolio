    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Get in touch with me through various channels."/>
            </Head>
            <section className="my-28">
                <div className="flex z-10 flex-col items-center">
                    <h1 className="text-4xl text-center font-bold mb-12">Contacts</h1>
                    <p className="text-center max-w-[60%] mb-12 text-lg">Welcome to the contact page! I am always glad
                        to
                        hear from you. Please contact me through any communication channel convenient for you. I will do
                        my
